...
#pragma region 기본 매개 변수
    // 함수를 선언할 때 매개 변수를 선언과 동시에
    // 초기화해 놓으며, 함수를 호출할 때 매개 변수를
    // 지정하지 않아도 기본값으로 설정됩니다.
...
#pragma region friend
    ...
    // protected 맴버에 접근을 허용하는 키워드 입니다.
